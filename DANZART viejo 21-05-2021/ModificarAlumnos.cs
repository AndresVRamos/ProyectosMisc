...
namespace DANZART
{
    public partial class frmModificarAlumnos : Form
    {
        ...
        public void llenacombobox()
        {
            ...
            SqlDataAdapter cbus = new SqlDataAdapter("SELECT IDALUMNO, NOMBRE_A FROM ALUMNOS", Conectar.Conectarbd);
        ...
        public void llenacombobox2()
        {
            ...
            SqlCommand comando = new SqlCommand("SELECT IDALUMNO, NOMBRE_A, APELLIDO_PAT, APELLIDO_MAT FROM ALUMNOS", Conectar.Conectarbd);
            Conectar.Abrir();
            ...
            SqlCommand comando2 = new SqlCommand("SELECT IDGRUPO, NOMBREG FROM GRUPOS", Conectar.Conectarbd);
            Conectar.Abrir();
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            SqlCommand comandoM = new SqlCommand(modificarAlumno, Conectar.Conectarbd);
            Conectar.Abrir();
