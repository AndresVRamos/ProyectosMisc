...
namespace DANZART
{
    public partial class frmModificarHorario : Form
    {
        ...
        public void llenacombobox()
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("SELECT IDIMPARTEN FROM IMPARTEN", Conectar);
            da.Fill(ds, "IMPARTEN");
            ...
            SqlDataAdapter da2 = new SqlDataAdapter("SELECT IDCLASE FROM CLASES", Conectar);
            da2.Fill(ds2, "CLASES");
            cbxClase.DataSource = ds2.Tables[0].DefaultView;
            cbxClase.ValueMember = "IDCLASE";

            DataSet ds3 = new DataSet();
            SqlDataAdapter da3 = new SqlDataAdapter("SELECT IDGRUPO FROM GRUPOS", Conectar);
            da3.Fill(ds3, "GRUPOS");
            cbxGrupo.DataSource = ds3.Tables[0].DefaultView;
            cbxGrupo.ValueMember = "IDGRUPO";

            DataSet ds4 = new DataSet();
            SqlDataAdapter da4 = new SqlDataAdapter("SELECT IDMAESTRO FROM MAESTROS", Conectar);
        ...
        {
            string modificarIDGrupo = "UPDATE IMPARTEN SET IDGRUPO = " + cbxGrupo.Text + ", IDCLASE = "+ cbxClase.Text +", IDMAESTRO = "+ cbxMaestro.Text +", HORA = '"+ tbxHora.Text +"', DIA = '"+ cbxDia.Text +"' where IDIMPARTEN = " + tbxIDhorario.Text;
            ...
            SqlCommand comandoG = new SqlCommand(modificarIDGrupo, Conectar);
            //SqlCommand comandoC = new SqlCommand(modificarIDClase, Conectar);
            //SqlCommand comandoM = new SqlCommand(modificarIDMaestro, Conectar);
            //SqlCommand comandoH = new SqlCommand(modificarHora, Conectar);
            //SqlCommand comandoD = new SqlCommand(modificarDia, Conectar);
            ...
            if (readerG.Read() == false)
            {
                readerG.Close();
                llenardgv();
                MessageBox.Show("El horario se Modifico Correctamente");
            }
            else
            {
                readerG.Close();
                MessageBox.Show("No se modifico el Horario");
            }
