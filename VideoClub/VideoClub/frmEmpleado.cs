...
namespace VideoClub
{
    public partial class frmEmpleado : Form
    {
        ...
        //static string cadena = "Data Source=26.209.163.41, 1433;Initial Catalog=VIDEOCLUB;Persist Security Info=True;User ID=" + claseUsuarios.Instance.usuarioSQL + ";Password=" + claseUsuarios.Instance.contrasenaSQL;
        ...
        {
            if (txtClave.Text == "" || txtPuesto.Text == "" || txtNombre.Text == "" || txtApellido.Text == "" || txtTelefono.Text == "")
            {
                btnAgregar.Enabled = false;
            }
            else
        ...
        private void frmEmpleado_Click(object sender, EventArgs e)
        {
            Limpiar();
        }
    }
